...
var Bot = /** @class */ (function () {
    ...
    Bot.prototype.clickAccedi = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.page.$x('//*[@id=\'react-root\']/section[1]/main[1]/article[1]/div[1]/div[1]/div[1]/div[2]/button[1]')];
                    case 1:
                        accedi = (_a.sent())[0];
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 4];
                    case 3:
                        console.error('Failed to click accedi button');
                        _a.label = 4;
                    case 4: return [2 /*return*/];
                }
            });
                ...
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        if ((Date.now() - time) >= 20 * 1000)
                            return [2 /*return*/];
                        return [3 /*break*/, 3];
                    case 5: return [4 /*yield*/, this.page.evaluate(function () { window.scrollTo(0, document.body.scrollHeight); })];
                    case 6:
                        _b.sent();
    ...
    Bot.prototype.getFollowedList = function () {
        return __awaiter(this, void 0, void 0, function () {
            var count, str_list, followers_button, list, _i, list_2, i, username;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 6:
                        ...
                        _a.label = 7;
                    case 7:
                        if (!(_i < list_2.length)) return [3 /*break*/, 10];
                        i = list_2[_i];
                        count++;
                        return [4 /*yield*/, this.page.evaluate(function (el) { return el.textContent; }, i)];
                    case 8:
